...
const command_1 = __nccwpck_require__(939);
...
const auth_1 = __nccwpck_require__(387);
const core_1 = __nccwpck_require__(592);
class OidcClient {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(486);
            }
            const agentOptions = {
...
(() => {
const core = __nccwpck_require__(592);
